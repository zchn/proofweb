/** $Id: domMenu.js 2252 2006-05-15 14:47:53Z dallen $ */
 ...
 *
 * Updated: $Id: domMenu.js 2252 2006-05-15 14:47:53Z dallen $
 *
...
function domMenu_activateSubMenu(in_parentElement)
{
	...
	var targetDoc = settings.get('subMenuTargetDocument');
	if (!targetDoc) {
		targetDoc = document;
	}
...
function domMenu_toggleSubMenu(in_parentElement, in_style)
{
    ...
    if (subMenu && subMenu.style.visibility != in_style) {
		...
		var targetOtherDoc = isFirstLevelSub && settings.get('subMenuTargetDocument');
